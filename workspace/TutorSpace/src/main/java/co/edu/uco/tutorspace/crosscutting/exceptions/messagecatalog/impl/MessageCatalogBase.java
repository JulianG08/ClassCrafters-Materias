...
public class MessageCatalogBase  implements MessageCatalog {
	...
	public final void inicializar() {
		...
		mensajes.put(CodigoMensaje.M00021.getIdentificador(), new Mensaje(CodigoMensaje.M00022, "Se ha presentado un problema tratando de iniciar una transacción SQL con la fuente de información deseada..."));
